...
const paymentAltMap: Record<string, string> = {
  'gpay': 'Google Pay',
  'phonepe': 'PhonePe',
  'paytm': 'Paytm',
...
const shippingAltMap: Record<string, string> = {
  'bluedart': 'Bluedart Express Shipping',
  'delhivery': 'Delhivery Shipping',
  'xpressbees': 'Xpressbees Shipping',
  'dtdc': 'DTDC Shipping',
};
        ...
        <Box sx={{ px: { xs: 2, sm: 3, md: 3, lg: 3 }, py: { xs: 3, sm: 4, md: 4, lg: 4 } }}>
          <Grid container spacing={4}>
            ...
            <Grid size={{ xs: 12, sm: 12, md: 3 }}>
              ...
              {success && (
                <Typography sx={{ color: 'green', mt: 1, fontSize: 12 }}>
            ...
            <Grid size={{ xs: 12, sm: 12, md: 3 }}>
              <Box sx={{ marginLeft: { md: '3vw', lg: '6vw' } }}>
                ...
                <IconButton size="small" component="a" href="https://www.facebook.com/profile.php?id=61576563387778" target="_blank" rel="noopener noreferrer" aria-label="Minicon on Facebook" title="Minicon Facebook" sx={{ color: '#fff', border: '1px solid #333', borderRadius: 1, '&:hover': { backgroundColor: 'rgba(255,255,255,0.08)' } }}>
                  ...
                  <IconButton size="small" component="a" href="https://www.instagram.com/minicon.in_?igsh=eG52aTJjcWhsdHJ5" target="_blank" rel="noopener noreferrer" aria-label="Minicon on Instagram" title="Minicon on Instagram" sx={{ color: '#fff', border: '1px solid #333', borderRadius: 1, '&:hover': { backgroundColor: 'rgba(255,255,255,0.08)' }}}>
                    <InstagramIcon fontSize="small" />
                  </IconButton>
                  <IconButton size="small" component="a" href="https://wa.me/918777073645" target="_blank" rel="noopener noreferrer" aria-label="Minicon on WhatsApp" sx={{ color: '#fff', border: '1px solid #333', borderRadius: 1, '&:hover': { backgroundColor: 'rgba(255,255,255,0.08)', } }} >
        ...
        {[
          ...
          >
            <Box
              ...
              src={logo}
              alt={
                Object.keys(paymentAltMap).find(key => logo.includes(key))
                  ? paymentAltMap[
                      Object.keys(paymentAltMap).find(key => logo.includes(key))!
                    ]
                  : 'Payment method'
        ...
        {[
          ...
          >
            <Box
              ...
              src={logo}
              alt={
                Object.keys(shippingAltMap).find(key => logo.includes(key))
                  ? shippingAltMap[
                      Object.keys(shippingAltMap).find(key => logo.includes(key))!
                    ]
                  : 'Shipping partner'
